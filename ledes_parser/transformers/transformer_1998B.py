...
class LineItemTransformer(Transformer):
    ...
    def EXP_FEE_INV_ADJ_TYPE(self, code):
    ...
    def INVOICE_DATE(self, t: Token):
        return datetime.strptime(str(t.value).strip(), self._date_format).date()
    ...
    def INVOICE_TOTAL(self, t: Token):
        return Decimal(str(t.value).strip())
